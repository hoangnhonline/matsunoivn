...
<!-- box gray-->
    <div class="box-gray-plain pc-p-bottom50">
            <div class="container">
                    <h2 class="title-h1">客室備品・アメニティ<span>Faxture ＆ Amenity</span></h2>
                        ...
                        <div class="group-room-x4 row">
                                    ...
                                    <div class="col-xs-3 col-sm-3">
                                            <div class="box-group-room">
                                                ...
                                                <div class="box-room-detail">バスアメニティ<br/>レモングラスの香りのシャンプー・コンディショナー・シャワージェル</div>
                                           </div>
                                    </div>
                                      <div class="col-xs-3 col-sm-3">
                                            <div class="box-group-room">
					...
					adj_height();
                     ...
                     <div class="clearfix"></div>
                        ...
                        <table class="table-style1 m-top40">
                            ...
                            <tr>
                                <th>無料貸出 </th>
                                <td>ケータイ充電器 ・水枕・体温計・目覚まし時計・クレンジング・化粧水(女性) </td>
                            </tr>
                            <tr>
                                <th>有料サービス </th>
                                <td>クリーニングサービス ドリンク販売空港送迎</td>
                            </tr>
                        </table>
