        ...
        <div class="box-right">
            ...
            <div class="group-contact">
               <div class="container-fluid">
                <div class="contact-top">
                    <div class="row">
                        <div class="col-xs-12"><a  href="<?php echo $site_url;  ?>/inquire/" class="btn btn-outline-success "><i class="fas fa-envelope fa-lg"></i>&nbsp;予約・問合せ</a>
                        </div>
                    </div>
            ...
            <div class="group-language">
						<ul>
							...
							<li><a href="<?php echo $site_url.'/vn'.$_SERVER['REQUEST_URI']; ?>" title="Vietnamese"><img src="http://matsunoi.vn/public/assets/images/vietnam.png" alt="Vietnamese"></a></li>
						</ul>
            </div>
