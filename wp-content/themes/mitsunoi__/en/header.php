        ...
        <div class="box-right">
            ...
            <div class="group-language">
						<ul>
							...
							<li><a href="<?php echo $site_url.'/vn'.str_replace('/en/','/',$_SERVER['REQUEST_URI']); ?>" title="Vietnamese"><img src="http://matsunoi.vn/public/assets/images/vietnam.png" alt="Vietnamese"></a></li>
						</ul>
            </div>
