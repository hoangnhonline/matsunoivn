...
<title>VỀ CHÚNG TÔI | Ho Chi Minh City Khách Sạn Business MATSUNOI</title>
            ...
            <div class="row pc-m-top50" >
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-detail">
                        <h2 class="title-h3"><span>Về khách sạn Matsunoi thành <br/>phố Hồ Chí Minh</span> </h2>
                        <div class="text-detail  m-top20">
                            <p>Với sự gia tăng không ngừng của khách du lịch cũng như các khách đi công tác thời gian gần đây, chúng tôi đã khai trương một khách sạn tại trung tâm thành phố Hồ Chí Minh vào tháng 11 năm 2017. Khách sạn chúng tôi hoạt động với tiêu chí mang một trải nghiệm Nhật Bản đến với đất nước Việt Nam. Bạn có thể tại hưởng một bữa ăn mang đậm chất lượng và phong cách Nhật Bản được chuẩn bị bởi đầu bếp người Nhật của chúng tôi cũng như được phục vụ theo một phong cách mang chất lượng Nhật Bản.</p>
                        </div>
                    </div>
                </div>
