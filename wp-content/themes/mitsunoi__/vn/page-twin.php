...
<title>PHÒNG TWIN | Ho Chi Minh City Khách Sạn Business MATSUNOI</title>
      ...
      <div class="container breadcrumb">
        ...
        <div class="container">
            ...
            <div class="txt-content m-top30 txt-center ">
                 Căn phòng đầy nắng và sự tiện nghi. Rất phù hợp cho ai ưa thích sự rộng rãi trong không gianm đặc biệt là các gia đình nhỏ.
            </div>
        </div>
    </div>
    <!-- box while end-->
