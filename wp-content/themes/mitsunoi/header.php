...
<header>
    ...
    <div class="header-top">
        <!-- box left -->
        <div class="box-left">
            <div class="logo"><a href="<?php echo $site_url; ?>/"><img src="<?php echo $site_url; ?>/images/header_logo.png" alt="ベトナム ホーチミンMATSUNOIホテル"><span>Matsunoi Hotel</span></a></div>
        </div>
        <!-- box left end-->
        <!-- box right -->
        <div class="box-right">
                    ...
                    <div class="row">
                     <div class="col-xs-6">
                       <div class="group-language">
                        ...
                        <div class="col-xs-6"><a  href="<?php echo $site_url;  ?>/inquire/" class="btn btn-outline-success "><i class="fas fa-envelope fa-lg"></i>&nbsp;予約・問合せ</a>
                        </div>
                    </div>
                     <div class="row box-tel">
                            <div class="col-xs-12"> <a href="tel:02838246068" class="btn btn-success btn-lg"> <i class="fas fa-phone"></i>&nbsp;028-3824-6068<br />
日本または日本の携帯電話から<br />お電話の場合は、＋84-28-3824-6068</a></div>
                     </div>
                </div>
    ...
    <div class="header-bottom">
           <ul>
               ...
               <li>
                   ...
                   <li>
                   <a href="<?php echo $site_url;  ?>/hotel-service/" <?php if( $post->ID == 1740) echo ' class="active"  ' ; ?> >
                       <span class="txt-title">ホテルサービス</span>

                   </a>
               </li>
               <li>
                   <a href="<?php echo $site_url;  ?>/sight_seeing/" <?php if( $post->ID == 1492 or $post->ID == 1500 or $post->ID == 1498 or $post->ID == 1496 or $post->ID == 1502 or $post->ID == 1494) echo ' class="active"  ' ; ?> >
               ...
               <li>
                   <a href="<?php echo $site_url;  ?>/faq/" <?php if( $post->ID == 1720) echo ' class="active"  ' ; ?> >
