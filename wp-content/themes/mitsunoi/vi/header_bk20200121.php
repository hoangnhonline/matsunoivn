            ...
            <div class="group-contact">
               <div class="container-fluid">
                <div class="contact-top">
                    <div class="row">
                        <div class="col-xs-12.5"><a  href="<?php echo $site_url.$lang; ?>/inquire/" class="btn btn-outline-success "><i class="fas fa-envelope fa-lg"></i>&nbsp;LIÊN HỆ ĐẶT PHÒNG</a></div>
                    </div>
                     <div class="row box-tel">
                            <div class="col-xs-12.5"> <a href="tel:02838246068" class="btn btn-success btn-lg"> <i class="fas fa-phone"></i>&nbsp;028-3824-6068<BR>Nếu gọi từ Nhật, vui lòng gọi số<BR>＋84-28-3824-6068</a></div>
                     </div>
                </div>
               ...
               <li>
                ...
                <li>
                   <a href="<?php echo $site_url.$lang; ?>/hotel-service/" <?php if( $post->ID == 1762) echo ' class="active"  ' ; ?> >
                       ...
                       <span class="txt-title">DỊCH VỤ KHÁCH SẠN</span>
                   </a>
               </li>
               <li>
