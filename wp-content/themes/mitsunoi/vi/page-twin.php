...
<title>PHÒNG TWIN | MATSUNOI Khách Sạn Hồ Chí Minh</title>
<meta name="description" content="Căn phòng Twin tại  Matsunoi khách sạn Hồ Chí Minh đầy nắng và sự tiện nghi. Rất phù hợp cho ai ưa thích sự rộng rãi trong không gianm đặc biệt là các gia đình nhỏ.">

<?php echo get_template_part('vi/head'); ?>
<link rel="canonical" href="http://matsunoi.vn/vi/rooms/twin/">
</head>
<body>
...
<div id="container">
            ...
            <div class="slidebox">
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/rooms/banner_1980x400-twin.png');   background-position: center;   background-size: cover;" >
                            ...
                            <div class="bg-container">
                                      <div  class="container">                         
                                              <div class="banner-title">PHÒNG TWIN</div>
                                      </div>
                            </div>
    ...
    <div class="box-white">
      ...
      <div class="container breadcrumb">
              <a href="<?php echo $site_url.$lang; ?>">TRANG CHỦ  </a> &nbsp;&gt; <a href="<?php echo $site_url.$lang; ?>/rooms/">PHÒNG </a> &nbsp;&gt; PHÒNG TWIN
    </div>
    
    
        <div class="container">
            <h1 class="title-h1">PHÒNG TWIN</h1>
            <div class="txt-content m-top30 txt-center ">
                 Căn phòng đầy nắng và sự tiện nghi. Rất phù hợp cho ai ưa thích sự rộng rãi trong không gianm đặc biệt là các gia đình nhỏ.<BR>
