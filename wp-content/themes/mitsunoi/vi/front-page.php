...
<link rel="canonical" href="http://matsunoi.vn/vi/">
    ...
    <ul class="group-mainbanner bxslider">
     ...
     <li class="slidebox " style="background-color:#FFF;">
              ...
              <li class="slidebox " style="background-color:#f6f7e5;">
                    ...
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/matsunoi_banner_1_jp.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ><a href="http://matsunoi.vn/vi/promotion/">RẤT NHIỀU CHƯƠNG TRÌNH KHUYẾN MÃI HẤP DẪN TẠI MATSUNOI!!! </a>
</div>
             ...
             <li class="slidebox " style="background-color:#97936e;">
                    ...
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/matsunoi_banner_2.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ><a href="http://matsunoi.vn/vi/promotion/">RẤT NHIỀU CHƯƠNG TRÌNH KHUYẾN MÃI HẤP DẪN TẠI MATSUNOI!!! </a></div>
