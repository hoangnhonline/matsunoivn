...
<title>DELUXE ROOM|MATSUNOI Hotel Ho Chi Minh</title>
<meta name="keywords" content="HCM hotel Booking, Ho Chi Minh Hotel booking, Saigon Hotel Booking, Vietnam Hotel  Booking">
<meta name="description" content="The bright deluxe room in Matsunoi Hotel Ho Chi Minh with 2 windows facing to the south. Spacious and well equipped room suitable for those want to spend their time relaxedly and slowly.">
<link rel="canonical" href="http://matsunoi.vn/en/rooms/deluxe/" />
...
<div id="container">
            ...
            <div class="slidebox">
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/rooms/banner_1980x400-deluxe.png');   background-position: center;   background-size: cover;" >
                            ...
                            <div class="bg-container">
                                  <div  class="container">                         
                                          <div class="banner-title">DELUXE</div>
                                  </div>
                            </div>
    ...
    <div class="container breadcrumb">
              <a href="<?php echo $site_url.$lang; ?>">HOME </a>&nbsp;&gt; &nbsp;<a href="<?php echo $site_url.$lang; ?>/rooms/">ROOMS </a>&nbsp;&gt; DELUXE
    </div>
    
    
        <div class="container">
            <h1 class="title-h1">DELUXE</h1>
            <div class="txt-content m-top30 txt-center ">
               Bright room with 2 windows facing to the south. Spacious and well equipped room suitable for those want to spend their time relaxedly and slowly.<BR>
<!-- <font color="red">Breakfast service is provided until 31/Oct/2020.</font><br/>-->
            ...
            <div class="container">
                     ...
                     <div class="room_gallerybox">
                                 <div class="main-gallery">
                                           <div class="select-img"><img src="<?php echo $site_url;  ?>/images/room_images/deluxe-01.jpg" alt="ホーチミン MATSUNOIホテル | デラックスルーム1" /></div>
                                 </div>
    ...
    <tr>
        <th>Price</th>
        <td><del>54 USD</del> <font color="FF0000"> *40USD</span> (Until 31/Jan/2021)</font>
			<br>There is no breakfast service.<br>
			<!--<br/>※ 1 room charge, no breakfast 54 USD </span><br/>
