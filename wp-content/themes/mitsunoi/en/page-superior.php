...
<title> SUPERIOR ROOM|MATSUNOI Hotel Ho Chi Minh </title>
<meta name="keywords" content="HCM hotel Booking, Ho Chi Minh Hotel, Saigon Hotel, HCM Hotel">
<meta name="description" content="Superior room in Matsunoi Hotel Ho Chi Minh is 16.5 m² without window. Small and quiet room accompanied by facing east window would provide an airy and bright atmosphere.">
<link rel="canonical" href="http://matsunoi.vn/en/rooms/superior/" />
...
<div id="container">
            ...
            <div class="slidebox">
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/rooms/banner_1980x400-superior.png');   background-position: center;   background-size: cover;" >
                                ...
                                <div class="bg-container">
                                  <div  class="container">                         
                                          <div class="banner-title">SUPERIOR</div>
                                  </div>
                            </div>
    ...
    <div class="box-white">
     ...
     <div class="container breadcrumb">
              <a href="<?php echo $site_url.$lang; ?>">HOME </a>&nbsp;&gt;&nbsp;<a href="<?php echo $site_url.$lang; ?>/rooms/">ROOMS </a>&nbsp;&gt; SUPERIOR
    </div>
    
    
    
        <div class="container">
            <h1 class="title-h1">SUPERIOR</h1>
            <div class="txt-content m-top30 txt-center ">
                       16.5 m² room with window. Small and quiet room accompanied by facing east window would provide an airy and bright atmosphere. <BR>
    ...
    <tr>
        <th>Price   </th>
        <td><del>49 USD</del> <font color="FF0000"> *35USD</span> (Until 31/Jan/2021)</font>
			<br>There is no breakfast service.<br>
			<!--<br/>※ 1 room charge, no breakfast 49 USD </span><br/>
