...
<header>
                ...
                <div class="contact-top">
                    <div class="row">
                     ...
                     <div class="group-language">
                        ...
                        <div class="col-xs-6"><a  href="<?php echo $site_url.$lang; ?>/inquire/" class="btn btn-outline-success "><i class="fas fa-envelope fa-lg"></i>&nbsp;BOOKING / INQUIRE</a></div>
                    </div>
                     <div class="row box-tel">
                    <div class="col-xs-12"> <a href="tel:02838246068" class="btn btn-success btn-lg"> <i class="fas fa-phone"></i>&nbsp;028-3824-6068<BR>When calling from Japan,<BR>please dial ＋84-28-3824-6068</a></div>
    ...
    <div class="header-bottom">
           <ul>
               <li>
                   <a href="<?php echo $site_url.$lang; ?>/about/" <?php if( $post->ID == 1633) echo ' class="active"  ' ; ?> >
               ...
               <li>
                ...
                <li>
                   <a href="<?php echo $site_url.$lang; ?>/hotel-service/" <?php if( $post->ID == 1750) echo ' class="active"  ' ; ?> >
               ...
               <li>
                   <a href="<?php echo $site_url.$lang; ?>/sight_seeing/" <?php if( $post->ID == 1504 or $post->ID == 1514  or $post->ID == 1516  or $post->ID == 1510  or $post->ID == 1512  or $post->ID == 1507 ) echo ' class="active"  ' ; ?> >
               ...
               <li>
                ...
                <li>
                   <a href="<?php echo $site_url.$lang; ?>/faq/" <?php if( $post->ID == 1745) echo ' class="active"  ' ; ?> >
