...
<div id="container">
    <!-- slide box -->
     ...
     <ul class="group-mainbanner bxslider">
          ...
          <li class="slidebox " style="background-color:#f6f7e5;">
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/banner_1_en.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ></div>
            </li>
            
             <li class="slidebox " style="background-color:#97936e;">
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/banner_2_en.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ></div>
            </li>
    </ul>
    ...
    <div class="box-white m_ptop80">
        <div class="container">
<div class="txt-content m-top20 txt-center" style="max-width:870px; margin:auto;"><font color="red">※ We will close for Tet Hodiday from 22/Jan/2020 to 02/Feb/2020 and reopen after Tet holiday from February 3rd.</font><br/>
