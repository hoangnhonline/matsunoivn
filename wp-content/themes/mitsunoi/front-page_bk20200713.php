    ...
    <!-- slide box -->
      ...
      <ul class="group-mainbanner bxslider">
          ...
          <li class="slidebox " style="background-color:#f6f7e5;">
                    ...
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/matsunoi_banner_1_jp.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ><a href="http://matsunoi.vn/promotion/">プロモーション実施中!!! </a>
</div>
             ...
             <li class="slidebox " style="background-color:#97936e;">
                    ...
                    <div class="slide-list" style="background-image: url('<?php echo $site_url;  ?>/images/home/matsunoi_banner_2.jpg');    background-position: center;   background-size: cover; max-width:1440px; margin:auto;" ><a href="http://matsunoi.vn/promotion/">プロモーション実施中!!! </a></div>
...
お二人でもゆったりとおくつろぎ頂けます。</div></div></a>
						...
						<ul>
							...
							<li><img src="http://matsunoi.vn/public/assets/images/ico_wifi.jpg"></li>

							<li><img src="http://matsunoi.vn/public/assets/images/ico_print.jpg"></li>

							<li><img src="http://matsunoi.vn/public/assets/images/ico_help.jpg"></li>
