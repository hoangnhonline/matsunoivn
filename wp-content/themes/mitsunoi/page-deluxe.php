...
<meta name="description" content="南に面した、窓二つの明るいお部屋です。20㎡あり、ゆったりお過ごしいただけます。 バスルームはコンパクトですが、大きめバスタブ完備。収納・デスクも完備のため、ビジネスで滞在の方にも便利です。" />
<?php echo get_template_part('head'); ?>
<link rel="canonical" href="http://matsunoi.vn/rooms/deluxe/">
</head>
<body>
    ...
    <div class="container breadcrumb">
        ...
        <div class="container">
            ...
            <div class="txt-content m-top30 txt-center ">
                     南側に窓が二つあり、明るいお部屋です。お一人でもゆったりとお過ごししたい方には、ぴったりのお部屋です。 お荷物の多い方も快適にご利用いただける広さです。 デスクも完備しておりますので、お仕事される方には便利です。 バスルームはコンパクトですが、大きめバスタブ完備。ゆっくりとおくつろぎいただけます。 <BR>
